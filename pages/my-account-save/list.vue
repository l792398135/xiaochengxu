<template>
  <view class="container">
    <unicloud-db ref="udb" v-slot:default="{data, pagination, loading, hasMore, error}" where="user_id==$cloudEnv_uid" :collection="collectionList" field="system,account,password,comment,imgs">
